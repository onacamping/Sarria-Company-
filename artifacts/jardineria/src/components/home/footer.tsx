...
export default function Footer() {
  ...
  const email = settings["business_email"] ?? "contacto@sarriacompany.com";
  const displayPhone = settings["business_phone"] ?? "+57 300 123 4567";
  const address = settings["business_address"] ?? "Bogotá D.C. y Sabana de Bogotá";
