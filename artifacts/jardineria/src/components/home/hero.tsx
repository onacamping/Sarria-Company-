...
import heroBg from "@/assets/hero-bg.jpg"; // We'll create a fallback if not present
    ...
    <section className="relative min-h-[90vh] flex items-center pt-20 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <img 
          ...
          onError={(e) => {
            (e.target as HTMLImageElement).src = "https://images.unsplash.com/photo-1558904541-efa843a96f09?auto=format&fit=crop&q=80&w=2000";
          }}
        />
      </div>
        ...
        <div className="max-w-3xl">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button size="lg" variant="outline" className="text-base h-14 px-8 bg-white/10 text-white hover:bg-white hover:text-primary border-white/30" asChild>
